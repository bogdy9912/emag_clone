...
class _$UpdateOrderInfo$ implements UpdateOrderInfo$ {
  const _$UpdateOrderInfo$(
      {this.address, this.products, this.total, this.methodOfPayment});
  ...
  @override
  String toString() {
    return 'UpdateOrderInfo(address: $address, products: $products, total: $total, methodOfPayment: $methodOfPayment)';
  }
...
abstract class UpdateOrderInfo$ implements UpdateOrderInfo {
  const factory UpdateOrderInfo$(
      ...
      BuiltList<CartItem> products,
      double total,
      PaymentMethod methodOfPayment}) = _$UpdateOrderInfo$;
